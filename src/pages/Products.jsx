            ...
            <div className="border-b border-[#141414] relative overflow-hidden flex flex-col justify-center min-h-[50vh] xl:min-h-[60vh]">
                ...
                <div className="container-orazal flex flex-col items-center text-center max-w-4xl mx-auto relative z-10 py-16 mt-10">
                    <div
                        ...
                        style={{ fontFamily: 'Kalam, cursive', opacity: 0.75 }}
                    >
                        {t('products.pre_title')}
                    </div>
                    <h1
                        className="text-6xl md:text-8xl lg:text-[7rem] font-light mb-8 drop-shadow-xl"
                        style={{ fontFamily: 'Rye, cursive', fontStyle: 'italic', textShadow: '0 10px 40px rgba(0,0,0,0.6)' }}
                    >
                        {t('products.title')}
                    </h1>
                    <p
                        className="text-[1.1rem] md:text-[1.3rem] max-w-2xl mx-auto"
                        style={{ fontFamily: 'Kalam, cursive', fontWeight: 300, color: '#c8bfb0', lineHeight: 1.8 }}
                    >
                        {t('products.subtitle')}
                    </p>
                </div>
            ...
            <section className="container-orazal py-8">
                <div className="flex flex-col lg:flex-row w-full mb-16 rounded-2xl overflow-hidden shadow-2xl" border="1px solid #1a1a1a" style={{ border: '1px solid #1a1a1a' }}>
                    ...
                    <div className="w-full lg:w-1/2 relative bg-[#050505] p-8 md:p-14 xl:p-16 flex flex-col group border-b lg:border-b-0 lg:border-r border-[#1a1a1a]" style={{ '--tw-drop-shadow': '0 0 20px rgba(0,0,0,0.5)', filter: 'var(--tw-drop-shadow)' }}>
                        <div className="absolute top-0 right-0 text-[10rem] leading-none font-light opacity-[0.02] select-none pointer-events-none" style={{ fontFamily: 'Rye, cursive', color: '#c8bfb0' }}>
                            A
                        </div>

                        <h3 className="text-3xl md:text-4xl font-light text-[#f0ebe2] mb-1" style={{ fontFamily: 'Rye, cursive' }}>Mezcal Casa Orazal</h3>
                        <h4 className="text-xl md:text-2xl text-[#c8bfb0] mb-8 font-light italic">Joven Arroqueño</h4>

                        <p className="text-[1.05rem] text-[#c8bfb0] leading-relaxed mb-8 font-light" style={{ fontFamily: 'Kalam, cursive' }}>
                        ...
                        <div className="mb-8">
                            <h5 className="text-[0.7rem] tracking-[0.25em] uppercase text-[#b8c4d4] opacity-80 mb-4 inline-block border-b border-[#b8c4d4]/30 pb-1" style={{ fontFamily: 'Kalam, cursive' }}>100% Artesanal y Tradicional</h5>
                            <p className="text-[0.95rem] text-[#a0988c] mb-3" style={{ fontFamily: 'Kalam, cursive' }}>Elaborado con un proceso único:</p>
                            <ul className="text-[0.9rem] text-[#a0988c] space-y-2 mb-4 font-light" style={{ fontFamily: 'Kalam, cursive' }}>
                            ...
                            <p className="text-[0.95rem] text-[#a0988c] italic" style={{ fontFamily: 'Kalam, cursive' }}>Un método tradicional que asegura un perfil puro, lleno de carácter y sabor auténtico.</p>
                        </div>

                        <div className="mb-10 flex-1">
                            <h5 className="text-[0.7rem] tracking-[0.25em] uppercase text-[#b8c4d4] opacity-80 mb-3 inline-block border-b border-[#b8c4d4]/30 pb-1" style={{ fontFamily: 'Kalam, cursive' }}>Toque del Espadín</h5>
                            <p className="text-[1rem] text-[#c8bfb0] leading-relaxed font-light" style={{ fontFamily: 'Kalam, cursive' }}>
                    ...
                    <div className="w-full lg:w-1/2 relative bg-[#0a0a0c] p-8 md:p-14 xl:p-16 flex flex-col group overflow-hidden">
                        ...
                        <div className="absolute top-0 right-0 text-[10rem] leading-none font-light opacity-[0.03] select-none pointer-events-none text-[#b8c4d4]" style={{ fontFamily: 'Rye, cursive' }}>
                            P
                        </div>
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            ...
                            <div className="mb-8">
                                ...
                                <p className="text-[0.95rem] text-[#a0988c] italic" style={{ fontFamily: 'Kalam, cursive' }}>Un método ancestral que asegura un perfil complejo, profundo y lleno de tradición.</p>
                            </div>

                            <div className="mb-10 flex-1">
                                <h5 className="text-[0.7rem] tracking-[0.25em] uppercase text-[#b8c4d4] opacity-80 mb-3 inline-block border-b border-[#b8c4d4]/30 pb-1" style={{ fontFamily: 'Kalam, cursive' }}>Toque del Papalometl (Arroqueño)</h5>
                                <p className="text-[1rem] text-[#c8bfb0] leading-relaxed font-light" style={{ fontFamily: 'Kalam, cursive' }}>
            ...
            <section className="section-pad border-t border-[#141414]">
                <div className="container-orazal max-w-3xl mx-auto text-center">
                    <div
                        ...
                        style={{ fontFamily: 'Kalam, cursive', opacity: 0.6 }}
                    >
                    ...
                    <p
                        ...
                        style={{ fontFamily: 'Kalam, cursive', fontWeight: 300, color: '#c8bfb0', lineHeight: 1.9 }}
                    >
